...
import pregant from '../../assets/icons/pregantPink900_128.png'
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-brown-900 truncate transition duration-150 ${pathname === '/' || pathname.includes('dashboard') ? 'hover:text-pink-900' : 'hover:text-white'}`}
                        onClick={(e) => {
                          e.preventDefault();
